...
This file provides context for AI assistants working with Ur/Web projects. For Cursor, you may copy this into `.cursor/rules/urweb.mdc` for automatic application to relevant files.
