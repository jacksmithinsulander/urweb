...
ur lsp
\end{verbatim}
Currently there are no prebuilt editor plugins to register this server with your editor of choice but it should be fairly simple to do so. For example in Emacs using the lsp-mode, all you need to make this connect to the Rust server is the following configuration (assuming you use the urweb-mode bundled with the compiler):
\begin{verbatim}
(require 'lsp)
