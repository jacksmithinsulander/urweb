...
CFLAGS="-std=c11 -pedantic -Wall -Wunused-parameter -Werror -Wno-format-security -Wno-deprecated-declarations -Wno-gnu-zero-variadic-macro-arguments -U_FORTIFY_SOURCE"
