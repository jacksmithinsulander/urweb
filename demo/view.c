...
sqlite3_stmt *stmt;
int res;
res = sqlite3_prepare_v2(conn->conn, "SELECT COUNT(*) FROM uw_View_t", -1, &stmt, NULL);
if (res != SQLITE_OK) uw_error(ctx, FATAL, "Table uw_View_t does not exist in the database.");
...
if (sqlite3_open("/tmp/view.db", &sqlite) != SQLITE_OK) uw_error(ctx, FATAL, "Can't open SQLite database.");
...
/* Function prototypes */
static uw_unit __uwn_expunger_1761(uw_context, uw_Basis_client);
static uw_unit __uwn_initializer_1762(uw_context, uw_unit);

static uw_unit __uwn_expunger_1761(uw_context ctx, uw_Basis_client __uwr_cli_0) {
return(0);
}

static uw_unit __uwn_initializer_1762(uw_context ctx, uw_unit __uwr___0) {
return(0);
}

#line 1 "/Users/jacksmith/prog/urweb/demo/view.ur"
/* SQL table uw_View_t  constraints  */

#line 2 "/Users/jacksmith/prog/urweb/demo/view.ur"
/* SQL view uw_View_v AS SELECT T_T.uw_a AS uw_a FROM uw_View_t AS T_T WHERE (T_T.uw_a > 7) */
